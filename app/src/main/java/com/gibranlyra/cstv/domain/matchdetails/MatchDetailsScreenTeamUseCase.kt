...
internal class MatchDetailsScreenTeamUseCase
@Inject
                        ...
                        try {
                            Result.Success(
                                MatchDetailsTeamsData(
                                    team1 =
                                    teamDataResult.data.find { teamData ->
                                        teamData.teamId == team1Id
                                    }
                                        ?: throw IllegalStateException(
                                            "TeamDataResult doesn't contains $team1Id",
                                        ),
                                    team2 =
                                    teamDataResult.data.find { teamData ->
                                        teamData.teamId == team2Id
                                    }
                                        ?: throw IllegalStateException(
                                            "TeamDataResult doesn't contains $team2Id",
                                        ),
                                ),
                            )
